...
const GITHUB_TOKEN = "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";
...
module.exports = {
  config: {
    ...
    category: "utility",
    guide: {
      en: "{pn} filename.js <code | url>\nOr reply to code and type: {pn} filename.js"
    }
  },
  ...
  annieStart: async function ({ bot, msg }) {
    try {
      ...
      if (!codeSource) {
        return bot.sendMessage(msg.chat.id, "❌ You must provide code or a valid code URL.", {
          parse_mode: "Markdown"
        });
      }
